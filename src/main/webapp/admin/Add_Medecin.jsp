                ...
                <div class="row" style="border: 5px solid #26b" class="wrapper fadeInLeft">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="../SaveServletUser"  method="post">
                            	<div class="form-group">
                                    <input type="hidden" class="form-control form-control-user" name="type"
                                        placeholder="type de commpte" value="medecin" style="text-align: center;" readonly="">
                                </div>
                                <div class="form-group">
                                    <center><span>Spécialité</span></center>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name="prenom" 
                                            placeholder="Prénom" style="text-align: center;">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="tel" class="form-control form-control-user" name="tel" 
                                            placeholder="Téléphone" style="text-align: center;">
                                    </div>
                                    <div class="col-sm-6">
